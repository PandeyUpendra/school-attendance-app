          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  _schoolName.isNotEmpty ? _schoolName : 'Owner Panel',
                  style: const TextStyle(
...
class _StaffPageState extends State<_StaffPage> {
            ...
            SliverToBoxAdapter(
              child: Padding(
                ...
                child: Row(children: [
                  ...
                  const SizedBox(width: 10),
                  Expanded(child: _StatCard(label: 'On Leave', value: '$onLeave', icon: Icons.event_busy_outlined, color: AppTheme.warning, compact: true)),
                  const SizedBox(width: 10),
                  Expanded(child: _StatCard(label: 'Active', value: '${_teachers.length - onLeave}', icon: Icons.check_circle_outline, color: AppTheme.success, compact: true)),
                ]),
              ),
            ),
  ...
  Widget _buildTeacherList(List<Map<String, dynamic>> filtered) {
    if (filtered.isEmpty) return _emptyCard(Icons.people_outline, 'No teachers found');
    return Padding(
      padding: const EdgeInsets.symmetric(horizontal: 14),
      child: Column(
            ...
            child: Row(children: [
              ...
              Container(
                ...
                child: Text(isOnLeave ? 'On Leave' : 'Active',
                  style: TextStyle(fontSize: 10, fontWeight: FontWeight.w600, color: isOnLeave ? AppTheme.warning : AppTheme.success)),
              ),
            ]),
          );
        }).toList(),
