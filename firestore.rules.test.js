...
const USERS = {
  ...
  // studentSection (what TimetableService.addAllowedUser actually writes) —
  // NOT classIds/studentIds, which the app never populates for guardians.
  [UID.guardian]: {
...
beforeEach(async () => {
  ...
  await testEnv.withSecurityRulesDisabled(async (ctx) => {
    ...
    // Fee structure (FeeService writes the `fee_structures` collection)
